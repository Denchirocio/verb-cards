    ...
    <div className="mx-auto flex w-full max-w-2xl flex-1 flex-col px-4 py-6">
      ...
      <div className="mt-4 flex w-full flex-1 flex-col items-center">
        <div
          ...
          className="relative flex min-h-[420px] w-full max-w-xl flex-1 cursor-grab select-none flex-col rounded-3xl border border-card-border bg-white p-6 text-left shadow-sm active:cursor-grabbing"
        >
          ...
          {!flipped ? (
            <div className="flex flex-1 flex-col items-center justify-center gap-2 text-center">
              <span className="flex items-center gap-1 text-base text-ink-soft/70">
                {verb.hiragana}
                <SpeakButton text={verb.hiragana} size={15} className="h-6 w-6" />
              </span>
              ...
              <span className="text-lg text-ink-soft">{verb.meaning}</span>
              <div className="my-2 h-px w-14 bg-card-border" />
              <span className="flex items-center gap-1.5 text-xs uppercase tracking-wide text-ink-soft/70">
                <RefreshCw size={12} />
            ...
            <div className="flex flex-1 flex-col items-center justify-center gap-2 text-center">
              <span className="flex items-center gap-1 text-base break-words text-ink-soft/70">
                {conjugated.hiraganaStem}
                <span className="text-accent">{conjugated.hiraganaEnding}</span>
                <SpeakButton text={`${conjugated.hiraganaStem}${conjugated.hiraganaEnding}`} size={15} className="h-6 w-6" />
              </span>
              <span className="font-serif text-4xl font-semibold break-words text-ink sm:text-5xl">
              ...
              <div className="my-2 h-px w-14 bg-card-border" />
              <p className="max-w-sm text-xs leading-snug text-ink-soft/80">{FORM_USAGE[verbForm]}</p>
            </div>
          )}
        </div>

        <p className="mt-4 text-xs text-ink-soft/60">Deslizá la card a los costados para cambiar de verbo</p>
      </div>
    </div>
  )
}
