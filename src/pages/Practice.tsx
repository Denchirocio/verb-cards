...
// Los verbos ya marcados como sabidos no desaparecen del mazo — solo se les
// baja la prioridad (key elevada a una potencia < 1 los empuja hacia el
// final del orden) para que aparezcan con menos frecuencia sin dejar de
// repasarse nunca del todo.
...
export default function Practice() {
  ...
  const known = knownSet.has(verb.kanji)
  ...
  function reshuffle() {
    setDeck(weightedShuffle(ALL_VERBS, knownSet))
    setIndex(0)
  }
